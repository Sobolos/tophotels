                ...
                <div class="header-nav-cont">
                    <ul class="header-nav-list hide-1023">
                        ...
                        <li class="header-nav-item">
                            <a href="" class="header-nav-link  disabled grey ">Мой профиль</a>
                        </li>
                        <li class="header-nav-item">
                            <a href="" class="header-nav-link  disabled grey">Отели</a>
                        </li>
                        <li class="header-nav-item">
                        ...
                        <li class="header-nav-item">
                            <a href="" class="header-nav-link  disabled grey">Добавить отзыв</a>
                        </li>
